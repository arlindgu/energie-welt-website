...
// Vercel serverless functions cap the whole request body at 4.5 MB; stay safely under that.
...
fileInput.addEventListener("change", () => {
  ...
  if (totalSize > MAX_TOTAL_BYTES) {
    ...
    warning.className = "text-sm text-red-600"
    warning.textContent =
      "Die ausgewählten Dateien sind zusammen zu gross (max. 4 MB). Bitte wählen Sie kleinere oder weniger Dateien."
